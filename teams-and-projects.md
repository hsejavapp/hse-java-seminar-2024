...
https://docs.google.com/spreadsheets/d/1BbPJ4ZnTd2F6IyhxWrul1k-QeaCYJT66APNpxkwuOsc/edit?usp=sharing
...
С каждой команды – публичное **мини-демо релиза на 5-7 мин.** в каждый **демо-день**. Пока планируется **5 демо-дней**: https://docs.google.com/spreadsheets/d/1BbPJ4ZnTd2F6IyhxWrul1k-QeaCYJT66APNpxkwuOsc/edit?usp=sharing.
...
**Можно и нужно** юзать:
  * Популярные библиотеки, *например*, Google Guava (Sets, Lists, MoreExecutors, Multimap, ...), Slf4j + Apache Log4J 2 (Slf4j + Logback), &hellip;
  * Паттерны, абстракции
...
```
Оценка за курс
https://docs.google.com/presentation/d/15QFljzVRbkkV0HRbIamO7SNVbnMNXN7oHD6BlSf7UPs/edit?usp=sharing
```
Оценка за проект = 
    0.4 (базовый балл)
